...
apiRouter.get("/geo/detect", (req, res) => {
  try {
    ...
    const countryCurrencyMap: Record<string, { currency: string; symbol: string; country: string; flag: string }> = {
      ...
      IN: { currency: "INR", symbol: "₹", country: "India", flag: "🇮🇳" },
      CN: { currency: "CNY", symbol: "¥", country: "China", flag: "🇨🇳" },
      JP: { currency: "JPY", symbol: "¥", country: "Japan", flag: "🇯🇵" },
      RU: { currency: "RUB", symbol: "₽", country: "Russia", flag: "🇷🇺" },
      TR: { currency: "TRY", symbol: "₺", country: "Turkey", flag: "🇹🇷" },
      ...
      SA: { currency: "SAR", symbol: "SAR", country: "Saudi Arabia", flag: "🇸🇦" },
      CH: { currency: "CHF", symbol: "CHF", country: "Switzerland", flag: "🇨🇭" },
      BR: { currency: "BRL", symbol: "R$", country: "Brazil", flag: "🇧🇷" },
      MX: { currency: "MXN", symbol: "Mex$", country: "Mexico", flag: "🇲🇽" },
      ...
      EG: { currency: "EGP", symbol: "E£", country: "Egypt", flag: "🇪🇬" },
      PK: { currency: "PKR", symbol: "Rs", country: "Pakistan", flag: "🇵🇰" },
      PH: { currency: "PHP", symbol: "₱", country: "Philippines", flag: "🇵🇭" },
      MY: { currency: "MYR", symbol: "RM", country: "Malaysia", flag: "🇲🇾" },
      ID: { currency: "IDR", symbol: "Rp", country: "Indonesia", flag: "🇮🇩" },
      TH: { currency: "THB", symbol: "฿", country: "Thailand", flag: "🇹🇭" },
      KR: { currency: "KRW", symbol: "₩", country: "South Korea", flag: "🇰🇷" },
      SG: { currency: "SGD", symbol: "S$", country: "Singapore", flag: "🇸🇬" },
      NZ: { currency: "NZD", symbol: "NZ$", country: "New Zealand", flag: "🇳🇿" },
      SE: { currency: "SEK", symbol: "kr", country: "Sweden", flag: "🇸🇪" },
      NO: { currency: "NOK", symbol: "kr", country: "Norway", flag: "🇳🇴" },
      PL: { currency: "PLN", symbol: "zł", country: "Poland", flag: "🇵🇱" },
      ...
      BE: { currency: "EUR", symbol: "€", country: "Belgium", flag: "🇧🇪" },
      AT: { currency: "EUR", symbol: "€", country: "Austria", flag: "🇦🇹" },
      GR: { currency: "EUR", symbol: "€", country: "Greece", flag: "🇬🇷" },
      PT: { currency: "EUR", symbol: "€", country: "Portugal", flag: "🇵🇹" },
      FI: { currency: "EUR", symbol: "€", country: "Finland", flag: "🇫🇮" }
    };
